...
void setup() {
 ...
 void loop() {
    ...
    if (timeOut+15700 < millis()) {        // idle state - 'breathe' the top and bottom LED to show program is looping
       uint32_t red = (breathe, 0, 0);
       breathe = breathe + change;
       strip.setPixelColor(0, red);
       strip.setPixelColor(27, red);
       strip.setPixelColor(28, red);
       strip.setPixelColor(57, red);
       strip.setPixelColor(58, red);
       strip.setPixelColor(87, red);
       strip.setPixelColor(88, red);
       strip.setPixelColor(117, red);
       strip.setPixelColor(118, red);
       strip.setPixelColor(147, red);
       strip.setPixelColor(148, red);
       strip.setPixelColor(177, red);
       strip.setPixelColor(178, red);
       strip.setPixelColor(207, red);
       strip.setPixelColor(208, red);
       strip.setPixelColor(237, red);
       strip.setPixelColor(238, red);
       strip.setPixelColor(267, red);
       strip.setPixelColor(268, red);
       strip.setPixelColor(297, red);
       strip.setPixelColor(298, red);
       strip.setPixelColor(327, red);
       strip.setPixelColor(328, red);
       strip.setPixelColor(357, red);
       strip.setPixelColor(358, red);
       strip.setPixelColor(387, red);
       strip.setPixelColor(388, red);
       strip.setPixelColor(417, red);
       strip.setPixelColor(418, red);
       strip.setPixelColor(446, red);
       strip.show();
 ...
 void topdown() {
    ...
    colourWipeDown(strip.Color(0, 0, 255), 300 );  // Warm White - RGB - then 4th number is delay
