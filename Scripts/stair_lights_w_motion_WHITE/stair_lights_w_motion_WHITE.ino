...
void setup() {
 ...
 void loop() {
   ...
   if (timeOut+15700 < millis()) {        // idle state - 'breathe' the top and bottom LED to show program is looping
       ...
       strip.setPixelColor(89, blue);
       strip.setPixelColor(90, blue);
       strip.setPixelColor(119, blue);
       strip.setPixelColor(120, blue);
       strip.setPixelColor(149, blue);
       strip.setPixelColor(150, blue);
       strip.setPixelColor(179, blue);
       strip.setPixelColor(180, blue);
       strip.setPixelColor(209, blue);
       strip.setPixelColor(210, blue);  
       strip.setPixelColor(239, blue);
       strip.setPixelColor(240, blue);
       strip.setPixelColor(269, blue);
       strip.setPixelColor(270, blue);
       strip.setPixelColor(299, blue);
       strip.setPixelColor(300, blue);
       strip.setPixelColor(329, blue);
       strip.setPixelColor(330, blue);
       strip.setPixelColor(359, blue);
       strip.setPixelColor(360, blue);
       strip.setPixelColor(389, blue);
       strip.setPixelColor(390, blue);
       strip.setPixelColor(419, blue);
       strip.setPixelColor(420, blue);
       strip.setPixelColor(449, blue);
       strip.show();
